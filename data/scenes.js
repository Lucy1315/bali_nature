...
export const scenes = [
  ...
  { id: 'find-your-base', module: 'areaExplorer', layout: 'wide', eyebrow: 'Find Your Base', title: '나에게 맞는 지역 선택하기', tagline: '네 지역, 네 가지 리듬', image: 'base-jimbaran', alt: '짐바란 해변의 잔잔한 저녁 파도와 흐린 하늘', credit: C('Akmaie Ajam', 'CC BY-SA 4.0', 'Jimbaran_sunset_2.jpg') },
