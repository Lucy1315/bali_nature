...
- 검증 4회차(2026-09-13, v3): 사진 중심 개정으로 FR-045~050·SC-011·012를 추가했다. 기술 용어(WebP·GSAP)는 spec이
  아니라 plan에만 두었고 spec은 '실제 사진·재사용 조건·부드러운 전환·정지 상태 가시성'으로 서술했다. 전 항목 통과.

- 검증 3회차(2026-09-13, v2): 노션 원문을 반영해 스펙을 다시 썼다(섹션 9개, 예산 7항목·IDR·수동
  환율, 체크리스트 6항목, Visa Last Updated 구조, Local Life 추가). 전 항목 통과, 명확화 표시 0건.
